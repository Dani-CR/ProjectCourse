...
/**
*  This file was automatically generated by EvoMaster on 2024-10-11T13:49:49.184980279+02:00[Europe/Rome]
 * <br>
...
public class EvoMaster_successes_Test {
    ...
    public void test_1() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/api/books?bibkeys=_vrac27V")
                .then()
                .statusCode(200)
                .assertThat()
                .contentType("application/json")
    ...
    public void test_2() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/search/authors.json?q=kLkM4d")
                .then()
                .statusCode(200)
                .assertThat()
                .contentType("application/json")
    ...
    public void test_3() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/subjects/f4z.json")
                .then()
                .statusCode(200)
                .assertThat()
                .contentType("application/json")
                .body("'key'", containsString("/subjects/f4z"))
                .body("'name'", containsString("f4z"))
    ...
    public void test_4() throws Exception {
        ...
        given().accept("*/*")
                .get(baseUrlOfSut + "/subjects/vshAR.json?details=false")
                .then()
                .statusCode(301)
                .assertThat()
