...
/**
*  This file was automatically generated by EvoMaster on 2024-10-11T17:05:08.486660717+02:00[Europe/Rome]
 * <br>
...
public class EvoMaster_successes_Test {
    ...
    public void test_0() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/search/authors.json?q=3tJe10vzYDZP")
                .then()
                .statusCode(200)
                .assertThat()
    ...
    public void test_1() throws Exception {
        ...
        given().accept("application/json")
                ...
                .contentType("application/json")
                .body("'numFound'", numberMatches(0.0))
                .body("'start'", numberMatches(28900.0))
                .body("'numFoundExact'", equalTo(true))
                .body("'docs'.size()", equalTo(0))
                .body("'num_found'", numberMatches(0.0))
                .body("'q'", containsString("YQTt6GemJED4naL"))
    ...
    public void test_3() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/subjects/gp1t8.json?details=false")
                .then()
                .statusCode(200)
                .assertThat()
                .contentType("application/json")
                .body("'key'", containsString("/subjects/gp1t8"))
                .body("'name'", containsString("gp1t8"))
    ...
    public void test_4() throws Exception {
        ...
        given().accept("*/*")
                .get(baseUrlOfSut + "/subjects/ZPBKNSINuG4dL.json")
                .then()
                .statusCode(301)
                .assertThat()
