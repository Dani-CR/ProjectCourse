...
/**
*  This file was automatically generated by EvoMaster on 2024-10-11T16:05:04.713782706+02:00[Europe/Rome]
 * <br>
...
public class EvoMaster_successes_Test {
    ...
    public void test_0() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/subjects/la.json")
                .then()
                .statusCode(200)
                .assertThat()
                .contentType("application/json")
                .body("'key'", containsString("/subjects/la"))
                .body("'name'", containsString("la"))
    ...
    public void test_3() throws Exception {
        ...
        given().accept("application/json")
                .get(baseUrlOfSut + "/search/authors.json?q=mJRVqEyy")
                .then()
                .statusCode(200)
                .assertThat()
                .contentType("application/json")
    ...
    public void test_4() throws Exception {
        ...
        given().accept("*/*")
                .get(baseUrlOfSut + "/subjects/aUUtHC.json?details=true")
                .then()
                .statusCode(301)
                .assertThat()
