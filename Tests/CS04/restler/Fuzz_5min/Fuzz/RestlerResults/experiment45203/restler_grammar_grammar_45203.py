...
_api_owners_post_id = dependencies.DynamicVariable("_api_owners_post_id")

_api_pets_post_id = dependencies.DynamicVariable("_api_pets_post_id")
...
def parse_apiownerspost(data, **kwargs):
    ...
    if temp_7262:
        dependencies.set_variable("_api_owners_post_id", temp_7262)


def parse_apipetspost(data, **kwargs):
    """ Automatically generated response parser """
    # Declare response variables
    temp_8173 = None
    ...
    # Set dynamic variables
    if temp_8173:
        dependencies.set_variable("_api_pets_post_id", temp_8173)
...
def parse_apipettypespost(data, **kwargs):
    ...
    # Set dynamic variables
    if temp_7680:
        dependencies.set_variable("_api_pettypes_post_id", temp_7680)
...
def parse_apispecialtiespost(data, **kwargs):
    ...
    # Set dynamic variables
    if temp_5581:
        dependencies.set_variable("_api_specialties_post_id", temp_5581)
...
def parse_apivetspost(data, **kwargs):
    ...
    # Set dynamic variables
    if temp_2060:
        dependencies.set_variable("_api_vets_post_id", temp_2060)
...
def parse_apivisitspost(data, **kwargs):
    ...
    # Set dynamic variables
    if temp_5588:
        dependencies.set_variable("_api_visits_post_id", temp_5588)

req_collection = requests.RequestCollection([])
# Endpoint: , method: Get
request = requests.Request([
    primitives.restler_static_string("GET "),
    primitives.restler_basepath("/petclinic"),
...
request = requests.Request([
    ...
    
    {
        ...
        'post_send':
        {
            'parser': parse_apiownerspost,
            'dependencies':
            [
                _api_owners_post_id.writer()
            ]
        }
...
request = requests.Request([
    ...
    primitives.restler_static_string("owners"),
    primitives.restler_static_string("/"),
    primitives.restler_static_string(_api_owners_post_id.reader(), quoted=False),
    primitives.restler_static_string(" HTTP/1.1\r\n"),
    primitives.restler_static_string("Accept: application/json\r\n"),
    primitives.restler_static_string("Host: localhost:9966\r\n"),
    primitives.restler_refreshable_authentication_token("authentication_token_tag"),
...
request = requests.Request([
    ...
    
    {
        ...
        'post_send':
        {
            'parser': parse_apipetspost,
            'dependencies':
            [
                _api_pets_post_id.writer()
            ]
        }
...
request = requests.Request([
    ...
    primitives.restler_static_string("pets"),
    primitives.restler_static_string("/"),
    primitives.restler_static_string(_api_pets_post_id.reader(), quoted=False),
    primitives.restler_static_string(" HTTP/1.1\r\n"),
    primitives.restler_static_string("Accept: application/json\r\n"),
    primitives.restler_static_string("Host: localhost:9966\r\n"),
    primitives.restler_refreshable_authentication_token("authentication_token_tag"),
